# YOLOv11 cotton classification recognition system

## Body

The cotton classification recognition system based on deep learning YOLOv11 is a cotton classification recognition detection system (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model).

nc:4, 
Names: ['G-arboreum', 'G-barbadense', 'G-herbaceum', 'G-hirsitum'], 
Number of datasets: 367 training set, 39 validation set.
